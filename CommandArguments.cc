...
CommandArguments::StringStorageType *CommandArguments::AddParam(const std::string& name, const std::string& desc, const std::string& default_value)
{
...
CommandArguments::NumStorageType *CommandArguments::AddNumber(const std::string& name, const std::string& desc, unsigned int default_value)
{
...
CommandArguments::FlagStorageType *CommandArguments::AddFlag(const std::string& name, const std::string& desc, bool default_value)
{
...
CommandArguments::StringListStorageType *CommandArguments::AddParamList(const std::string& name, const std::string& desc)
{
...
bool CommandArguments::ApplyArgumentList(int argc, char** argv)
{
  ...
  while (arg < argc) {
    ...
    while (*szArgPtr == '-') ++szArgPtr;

    char *szValPtr = szArgPtr;
    while (*szValPtr && *szValPtr != '=') ++szValPtr;
